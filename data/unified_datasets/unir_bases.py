# Caráter expositivo, pois os CSVs individuais de cada estado estão salvos na nuvem.
import pandas as pd
import os

# Este script foi usado para unir cada CSV de cada estado e criar um único dataset, que é usado para as análises.

# Definir o diretório onde os arquivos CSV estão localizados
diretorio_entrada = '.'  # Diretório atual onde os arquivos CSV estão localizados
